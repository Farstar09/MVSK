  ...
  return (
    <footer className="bg-mvsk-gray border-t border-mvsk-blue/20 mt-20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-t border-mvsk-blue/20 mt-8 pt-8 text-center text-gray-400 text-sm animate-fade-in delay-300">
          <p>&copy; {new Date().getFullYear()} MVSK Esports. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
