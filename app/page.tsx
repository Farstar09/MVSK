  ...
  return (
    <div>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-mvsk-blue/10 to-transparent"></div>
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl">
            <h1 className="text-6xl md:text-8xl font-bold mb-6 text-mvsk-blue">
              MVSK
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link 
                href="/schedule" 
                className="px-8 py-3 border border-mvsk-blue hover:bg-mvsk-blue/10 rounded-lg font-semibold transition-colors"
              >
                View Schedule
              </Link>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/schedule" className="text-mvsk-blue hover:underline">
              Full Schedule →
            </Link>
          </div>
          <div className="space-y-4">
            <div className="bg-mvsk-gray border border-mvsk-blue/20 rounded-lg p-6 flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="text-gray-400">19:00 EST</div>
            </div>
            <div className="bg-mvsk-gray border border-mvsk-blue/20 rounded-lg p-6 flex flex-col md:flex-row items-center justify-between">
              <div className="flex items-center space-x-6 mb-4 md:mb-0">
                <div className="text-center">
              ...
              <div className="text-gray-400">20:00 EST</div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="bg-mvsk-gray border border-mvsk-blue/20 rounded-lg p-8">
              ...
              <div className="space-y-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center space-x-4 p-4 bg-mvsk-dark rounded-lg hover:bg-mvsk-dark/50 transition-colors"
                >
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
            ...
            <div className="w-40 h-24 bg-mvsk-gray border border-mvsk-blue/20 rounded-lg flex items-center justify-center text-gray-400 hover:border-mvsk-blue transition-colors">
              Partner 1
            </div>
            <div className="w-40 h-24 bg-mvsk-gray border border-mvsk-blue/20 rounded-lg flex items-center justify-center text-gray-400 hover:border-mvsk-blue transition-colors">
              Partner 2
          ...
          <div className="text-center mt-8">
            <Link href="/partners" className="text-mvsk-blue hover:underline">
              View All Partners →
            </Link>
          </div>
        </div>
